...
import bus.OrderBUS;
import bus.OrderDetailRoomBUS;
import bus.OrderDetailServiceBUS;
import entity.*;
...
public class FormOrderManagement extends JPanel {
    ...
    private OrderDetailRoomBUS orderDetailRoomBUS = new OrderDetailRoomBUS();
    private OrderDetailServiceBUS orderDetailServiceBUS = new OrderDetailServiceBUS();
    ...
    private void reloadData() {
        ...
        if ("Tất cả".equalsIgnoreCase(status)) orders = orderBUS.getAllOrders();
        else orders = orderBUS.getOrdersByStatus(status);
