...
AS
BEGIN
    DECLARE @orderID CHAR(8), @serviceID CHAR(6), @price MONEY, @serviceFee MONEY;
    ...
    SELECT @serviceID = serviceID, @price = price
    FROM Service
...
INSERT INTO Employee (fullName, phone, email, employeeTypeID, imgSource, gender) VALUES (N'Sơn Tùng MTP', '0987654321', 'baodinh.nguyen321@gmail.com', 'ET0001', 'images/fox_profile.png', 1); -- Lễ tân
